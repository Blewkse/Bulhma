...
const incrementPoints = (player: number) => {
  if (player === 1) {
    if (
      player1Points.value === 'Adv' ||
      (typeof player1Points.value === 'number' && player1Points.value >= 40)
    ) {
      player1Games.value++
      resetPoints()
      checkGames(1)
    ...
    if (
      player2Points.value === 'Adv' ||
      (typeof player2Points.value === 'number' && player2Points.value >= 40)
    ) {
      player2Games.value++
      resetPoints()
      checkGames(2)
